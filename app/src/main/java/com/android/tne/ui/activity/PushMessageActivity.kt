...
import com.android.tne.databinding.ActivityPushMessageBinding

class PushMessageActivity : AppCompatActivity() {
    lateinit var binding: com.android.tne.databinding.ActivityPushMessageBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnFb.setOnClickListener {
            val intent = Intent(this@PushMessageActivity,FcmActivity::class.java)
