...
import com.android.tne.databinding.ActivityFcmBinding
import com.google.android.gms.tasks.OnCompleteListener
import com.google.firebase.messaging.FirebaseMessaging

class FcmActivity : AppCompatActivity() {
    private lateinit var binding : com.android.tne.databinding.ActivityFcmBinding
    ...
    private fun setMusic(){
        //커스텀 뮤직 설정
        mediaPlayer = MediaPlayer.create(applicationContext, com.google.firebase.R.raw.keep)//음악선택
